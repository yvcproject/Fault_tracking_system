...
<!--<body style="padding-left: 10%; padding-right: 10%; align-content: center"> --> 
    ...
    <?php  
        ...
        echo "<table id=\"t\" class=\"table-condensed table-hover table table-striped table-bordered\" 
		...
		if($run){
         while($row = mysqli_fetch_array($run)) 
         {
            ...
            echo "<tr class=\"accordion-toggle collapse\" collapse($row[ID])\">";
            ...
            echo "<tr>";
            echo "<td></td>";
            echo "<td id=\"$row[ID]\" class=\"hide-table-padding\" colspan=\"4\"> $row[faultDescription] </td>";
            echo "</tr>";
         }
        }
       echo "</table>"
